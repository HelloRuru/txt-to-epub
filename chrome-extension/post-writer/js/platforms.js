...
export const TEMPLATE_MODES = [
  { id: 'original', name: '調整空行', description: '保留原文內容，僅修復平台換行消失問題' },
  { id: 'theater', name: '雜誌設計', description: '符號轉換・欄位對齊・標題飾條' },
  { id: 'broetry', name: 'Broetry文體', description: '自動分段・雙換行・留白節奏' },
]
