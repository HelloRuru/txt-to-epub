...
export const routes = [
  ...
  },
  {
    ...
    title: 'EPUB 編輯器',
    seo: {
      title: 'EPUB 編輯器 — 免費線上 EPUB 電子書編輯工具｜HelloRuru',
      description: '免費線上 EPUB 編輯工具：簡轉繁、台灣標點符號轉換、字型替換、行距字級調整。使用 OpenCC 引擎，保留原書排版。全程瀏覽器本機處理。',
      keywords: 'EPUB編輯器,EPUB簡轉繁,電子書編輯,字型替換,標點符號轉換,OpenCC,免費工具,本機處理',
      canonical: `${BASE}/epub-editor`,
      jsonLd: {
        '@context': 'https://schema.org',
        '@type': 'WebApplication',
